...
@Composable
fun EditTravelDescriptionSection(innerpadding: PaddingValues, viewModel: CreateTravelViewModel) {
    val alpha = remember {
        Animatable(0f)
    }
    ...
    Box(
        ...
        BasicTextField(
            value = viewModel.travelDescriptionTemp,
            onValueChange = { viewModel.travelDescriptionTemp = it },
